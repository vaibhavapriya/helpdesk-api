...
Route::group(['middleware'=>'auth:sanctum'],function () {
    Route::get('/profile/{id}',[ProfileController::class,'show'])->name('profile');//'auth.login'//done
    Route::put('/profile/{id}',[ProfileController::class,'update'])->name('profile-p');//c
    //Route::put('/profile/{id}/changePassword',[ProfileController::class,'changePassword'])->name('profile-p');
    Route::get('/mytickets',[TicketController::class,'index']);//done
    Route::post('/mytickets',[TicketController::class,'store']);//c
    Route::get('/tickets/{id}',[TicketController::class,'show']);//done
